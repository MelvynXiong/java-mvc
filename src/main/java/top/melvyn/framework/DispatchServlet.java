...
import top.melvyn.controller.IndexController;
import top.melvyn.controller.UserController;
            ...
            for (Class<?> parameterClass : method.getParameterTypes()) {
              if (!supportedPostParameterTypes.contains(parameterClass)) {
                if (requestBodyClass == null) {
                  ...
                  throw new UnsupportedOperationException(
                      "Unsupported duplicate request body type: " + parameterClass + " for method: "
                          + method);
                }
              }
            }
...
class GetDispatcher extends AbstractDispatcher {
  ...
  public GetDispatcher(Object instance, Method method, String[] parameterNames,
